...
/* 설명.
 *  Statement와 달리 placeholder(?)를 통한 SQL Injection 공격을 막을 수 있기 때문에
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        String query = "SELECT * FROM EMPLOYEE WHERE EMP_ID = ? AND EMP_NAME = ?";  // placeholder 앞뒤로는 자동으로 '' 이 붙기 때문에 별도로 싱글쿼테이션을 사용하지 않는다.
