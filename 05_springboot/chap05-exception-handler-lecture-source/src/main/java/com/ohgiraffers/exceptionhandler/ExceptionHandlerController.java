...
public class ExceptionHandlerController {
    ...
    public String annotationNullPointerExceptionTest() {
        String str = null;
        System.out.println("str.charAt(0): " + str.charAt(0));  // NullPointerException 발생

        return "/";
    }

    /* 설명. 이 클래스만 해당되는 지역범위 예외처리 설정 */
    @ExceptionHandler(NullPointerException.class)   // 이 클래스에 한해서 전역 설정보다 우선시되는 예외 처리 설정
    ...
    /* 설명. Model과 해당 Exception을 같이 활용할 수도 있다. */
