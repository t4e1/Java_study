package com.ohgiraffers.section01.scope.sigleton;
...
public class Application {
     ...
     *               웹 애플리케이션 컨텍스트에만 해당된다.
     *   5. globalSession: 전역 세션 당 하나의 인스턴스를 생산하고, 전역 세션이 종료되면 인스턴스를 폐기한다.
    ...
    * */
    public static void main(String[] args) {
        ...
        String[] beanaNames = context.getBeanDefinitionNames();
        for (String beanName : beanaNames) {
        ...
        /* 설명. 또 다른 손님이 쇼핑 카트를 꺼내 물건을 담는다. */
        ShoppingCart cart2 = context.getBean("cart", ShoppingCart.class);
        cart2.addItem(water);

        /* 설명. 두 번째 손님의 쇼핑 카트 확인 */
