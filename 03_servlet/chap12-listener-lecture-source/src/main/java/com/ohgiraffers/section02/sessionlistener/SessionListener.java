...
public class SessionListener implements HttpSessionListener, HttpSessionAttributeListener/*, HttpSessionBindingListener*/ {
    ...
    /* 설명. Binding 리스너는 SessionListener가 아닌 SEssion에 담기는 타입의 클래스에 직접 정의해야 한다. */
    ...
    public void attributeReplaced(HttpSessionBindingEvent event) {
        System.out.println("setssion attribute replaced");
    }

    @Override
    public void sessionCreated(HttpSessionEvent se) {
        System.out.println("session created");
        System.out.println("session 생성될 때 key값 : " + se.getSession().getId());
    }
