...
public class Application {
    ...
    private static int inputPrice() {
        Scanner sc = new Scanner(System.in);
        System.out.print("최대 금액을 입력해 주세요 : ");
        return sc.nextInt();
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            System.out.println("1. 카테고리의 상위 분류별 메뉴 보여주기(식사, 음료, 디저트)");
            System.out.println("9. 이전 메뉴로");
    ...
    /* 설명. 1부터 21까지의 랜덤된 5개의 중복되지 않는 번호 생성해 List에 쌓아서 반환하는 메소드  */
    private static List<Integer> generateRandomMenuCodeList() {
        ...
        System.out.println("생성한 랜덤 : " + list);
        ...
        do {
            ...
            switch (no) {
                case 1 :
                    ...
                    break;
                case 2 :
                    menuService.seacrhMenuByNameOrCategory(inputSearchCriteriaMap());
                    break;
                case 3 :
