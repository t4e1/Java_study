...
/* 설명. remix의 핵심은 DAO 계층을 인터페이스로 만들고 추상메소드만 남기는 것이다. */
...
public class Application {
        ...
        do {
            ...
            switch(no) {
                case 1 :
                    ...
                    break;
                case 2 :
                    menuController.findMenuByCode(inputMenuCode());
                    break;
                case 3 :
    ...
    /* 설명. 사용자의 입력값을 Map 형태로 반환(web에서는 key-value형태로 request 객체에 담기는 parameter로 생각) */
    ...
    private static Map<String, String> inputMenu() {
        ...
        System.out.print("신규 메뉴의 카테고리 번호를 입력해 주세요 : ");
