...
public class AssertJTests {
    ...
    /* 수업목표. test third part lib 중 AssertJ의 사용법에 대해 이해할 수 있다. */
    ...
    /* 목차. 3. 날짜 테스트하기 */
    /* 필기. 날짝 객체가 가지는 년,월,일,시,분,초,밀리초,나노초 까지도 검증이 가능하며, 특정 날짜 범위, 이전, 이후 내용도 검증이 가능 */
    @Test
