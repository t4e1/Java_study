package com.ohgiraffers.section01.obejct.dto;
...
//    }
    ...
    /* 설명. 우리가 BookDTO 타입의 객체가 동등하다 라는 것에 대한 기준을 정하기 위해 오버라이딩 */
    @Override
...
//    @Override
//    public int hashCode() {             // native 로 작성된 코드는 함부로 오버라이딩 하면 jdk 가 날아간다.
