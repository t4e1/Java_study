...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
         *  StringBuilder : StringBuffer보다 성능(=속도)이 좋음.
...
//        StringBuilder sb2 = "java";   // StringBuilder는 문자열을 다루지만 리터럴은 다루지 않음
        ...
        for (int i = 0; i <= 9; i++) {
            ...
            * */
            System.out.println("String 의 경우: " + System.identityHashCode(testStr));
            System.out.println("StringBuilder 의 경우: " + System.identityHashCode(testSb));
        }
