...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. StringBuilder와 자주 사용되는 메소드의 용법을 이해할 수 있다. */
        ...
        StringBuilder sb2 = new StringBuilder("javamariaDB");       // 문자열 크기 + 16byte가 할당된다.

        /* 필기.
         *  delete(): 시작 인덱스와 종료 인덱스를 이용해서 문자열에서 원하는 부분의 문자열을 제거한다.
         *  deleteCharAt(): 문자열 인덱스를 이용해서 문자 하나를 제거한다.
        * */
//        System.out.println("delete(): " + sb2.delete(2, 5));                // jarriaDB
