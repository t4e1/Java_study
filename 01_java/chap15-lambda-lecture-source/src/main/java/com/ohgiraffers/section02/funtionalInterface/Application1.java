...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 표준 함수적 인터페이스 중 Consumer에 대해 이해하고 활용할 수 있다. */
         ...
         *  3. Function: 매개변수와 리턴 값이 있는 applyXXX() 메소드를 지니고 있다. (매개변수를 리턴값으로 매핑하는 역할)
         *  4. Operator: Function과 같이 applyXXX() 메소드를 지니고 있다. 차이점은 매개변수 및 반환형의 타입이 통일되어 있다.
         *  5. Predicate: 매개변수와 boolean 값을 반환하는 testXXX()를 지니고 있다.(매개변수를 활용하여 boolean 변환)
        * */
//        Consumer<String> consumer = (str) -> {System.out.println(str + "이(가) 입력됨");};
        ...
        objIntConsumer.accept(new Random(), 19);
    }
}
