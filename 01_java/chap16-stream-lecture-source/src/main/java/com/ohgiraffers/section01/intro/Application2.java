...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        List<String> stringList =
                new ArrayList<>(Arrays.asList("java", "oracle", "jabac", "html", "css"));

        /* 설명. main 쓰레드에서 stream 사용하지 않고 확인 */
        System.out.println("============  foreeact");
...
//        stringList.forEach(s -> System.out.println(s + " : " + Thread.currentThread().getName()));
        ...
        /* 설명. 병렬 스트림 사용시 쓰레드 확인(속도가 상대적으로 더 빠르다. 또한 기본 main 쓰레드 외에 다른 쓰레드를 활용한다.) */
