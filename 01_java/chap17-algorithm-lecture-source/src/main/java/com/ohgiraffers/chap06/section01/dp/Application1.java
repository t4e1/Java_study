...
/* 필기.
 *  복잡한 전체 문제를 작은 부분 문제로 나누어,
 *  작은 부분 문제에 대한 최적의 해결방법을 고안하여 해결하는 알고리즘이다.
        ...
        * */
        for (int i = 6; i <= N; i++) {
            ...
            /* 설명. 한 종류가 아닌 봉지들로 설탕을 처리하는 경우 */
                ...
                /* 설명. 3 또는 5의 배수 구간이 아니지만 3 또는 5 킬로그램짜리 봉지를 하나 더 들고 갈 수 있는 경우에만(ex.23kg)  */
