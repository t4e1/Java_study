...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *      두 번째 이후에는 인스턴스 생성 시간 없이 바로 사용할 수 있다.(재사용)
         ...
         * 필기.
         *  싱글톤 구현 방법
         *   1. 이른 초기화(Eager Initialization) : 시작 시에 바로 static 영역에 올리는 방법
         *   2. 늦은 초기화(Lazy Initialization) : 사용 시에 바로 static 영역에 올리는 방법
        * */

        /* 설명. */
        EagerSingleton eager1 = EagerSingleton.getInstance();
//        eager1 = new EagerSingleton();              //  EagerSingleton()을 private 처리했기 때문에 외부에서 객체 생성 불가능
         ...
         *  반면, 늦은 초기화를 사용하면 클래스를 로드하는 속도는 빠르지만 첫 번째 요청에 대한 속도가 두 번째 요청에
