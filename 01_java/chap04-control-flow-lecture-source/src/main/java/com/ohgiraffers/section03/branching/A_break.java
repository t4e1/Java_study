...
public class A_break {
    ...
    public void testSimpleBreakStatement() {
        ...
        /* 필기. 중첩 반복문에서 가장 가까운 하나만을 빠져나가고, 상위의 반복문은 빠져나가지 않는다 */
        int sum = 0;
        int i = 1;
        while(true) {                               // 무한루프(infinite loop)
            ...
            if (i == 10) {                          // 반복문에서는 일반적으로 반복문 안에서 조건문을 써서 break를 사용한다.
                break;
            }
            i++;
        }
    ...
    public void testPrintStarsWithBreakStatement() {
        ...
        /* 수업목표. 중첩반복문을 활용하는 별찍기 문제에서 안쪽 for문 안에 break를 활용하여 효율적인 반복문을 작성해 보자.
         * 설명.
         *   양의 정수를 입력하시오 : 5
         *   *
         *   **
