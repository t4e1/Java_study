...
public class Order {
    ...
    /* 설명 insert의 편리함을 위해 Order의 개념인 OrderMenu 엔티티까지 포함해서 필들르 작성한다.(insert 시 추가) */
    ...
    public Order(LocalDate orderDate, LocalTime orderTime, int totalOrderPrice, List<OrderMenu> orderMenus) {
        ...
        this.orderDate = orderDate.format(DateTimeFormatter.ofPattern("yyyyMMdd")); // LocalDate 타입의 자료를 String 형태로 바꾸는 작업
